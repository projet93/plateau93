...
export class StadeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.stadeService
        ...
        .subscribe(
          (res: HttpResponse<IStade[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInStades(): void {
    this.eventSubscriber = this.eventManager.subscribe('stadeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStade[] | null, headers: HttpHeaders, page: number): void {
